    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative border-b hairline bg-background">
        <div className="mx-auto w-full max-w-[1440px] px-6 pb-16 pt-32 lg:px-10 lg:pb-24 lg:pt-40">
          <div className="eyebrow mb-4">§ About QianTron</div>
          <h1 className="max-w-[18ch] font-display text-[clamp(2.5rem,6vw,5.5rem)] leading-[0.98] tracking-tight text-balance">
      ...
      <section className="border-b hairline bg-muted/40 py-24">
        <div className="mx-auto grid w-full max-w-[1440px] gap-10 px-6 lg:grid-cols-2 lg:px-10">
          {PRINCIPLES.map((p, i) => (
            <div key={p.t} className="border-t hairline pt-6">
              ...
              <p className="mt-2 max-w-md text-base text-muted-foreground">{p.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-background py-24">
        <div className="mx-auto grid w-full max-w-[1440px] gap-10 px-6 lg:grid-cols-4 lg:px-10">
          {[
            ...
            <div key={l}>
              ...
              <div className="mt-2 font-mono-brand text-[10px] uppercase tracking-[0.24em] text-muted-foreground">
                {l}
              </div>
            </div>
          ))}
